...
def generate_launch_description():
    ...
    ld = AgentLaunchDescription(
        ...
        init_params={
            ...
            'init_bset': use_case_share_dir + '/launch/tetrabotC3PO/init_bset.yaml',
            'init_dset': use_case_share_dir + '/launch/tetrabotC3PO/init_dset.yaml',
            'init_reactive_rules_set': use_case_share_dir + '/launch/tetrabotC3PO/init_rrules.yaml',
